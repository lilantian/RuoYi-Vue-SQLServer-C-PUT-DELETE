...
import com.ruoyi.framework.web.service.CasUserDetailsServiceImpl;
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception
    {
        ...
        if (!casProperties.isCasEnable()) {
            ...
            securityFilterChain = httpSecurity
                    ...
                    // Custom JWT based security filter for cas
                    .addFilter(casAuthenticationFilter())
                    .addFilterBefore(authenticationTokenFilter, CasAuthenticationFilter.class)
                    .addFilterBefore(singleSignOutFilter(), CasAuthenticationFilter.class)
                    // 认证失败处理类
                    .exceptionHandling(exception -> exception.authenticationEntryPoint(casAuthenticationEntryPoint()))
                    // 添加CORS filter
                    .addFilterBefore(corsFilter, JwtAuthenticationTokenFilter.class)
                    .addFilterBefore(corsFilter, LogoutFilter.class)
